@section('head')
	...
	<meta name="msapplication-TileImage" content="{{ asset('packages/main/img/favicon/ms-icon-144x144.png') }}">
	...
	<link rel="stylesheet" type="text/css" href="{{ asset('packages/main/css/login-theme.css') }}" />
	...
	<!-- <link href="{{ asset('packages/main/css/stylesheets.css') }}" rel="stylesheet" type="text/css"/> -->
	...
	<link rel="stylesheet" href="{{ asset('assets/themes/default/css/fresh.css') }}">
