...

{
	...
	public function sendMail($to, $subject, $body, $cc = [], $bcc = [], $attach_file = [],$from = 'ezwebtools@gmail.com', $from_name = 'EzWeb Company', $to_name=''){
		...
		try {
		    ...
		    $mail->SMTPAuth = true;                          
		    $mail->Username = env('MAIL_USERNAME', "ezwebtools@gmail.com");
		    $mail->Password = env('MAIL_PASSWORD', "6%cBn:wQ1x");
