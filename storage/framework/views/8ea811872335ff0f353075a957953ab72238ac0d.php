...
<li>
	<a href="<?php echo e(URL::route('admin.home')); ?>">Form Payment Config</a>
</li>
								...
								<?php foreach ($listForm as $k => $frm): ?>
									<tr>
										...
										<td>
						    				...
						    				<a id="update_frm_<?php echo e($frm->id); ?>" rel="<?php echo e($frm->id); ?>" href="<?php echo e(route('admin.newForm',['id'=>$frm->id])); ?>">
						    				...
						    				<a target="_blank" href="<?php echo e(route('admin.viewEmail',['id' => $frm->id])); ?>">View content email </a>
