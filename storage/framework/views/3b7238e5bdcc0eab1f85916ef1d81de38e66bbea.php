	...
	<ul class="nav">
		...
		<li class="dropdown-submenu <?php if($module == 'admin' || $module == 'logAdmin'): ?> active <?php endif; ?>">
			...
			<a href="<?php echo e(URL::route('admin.listForm')); ?>">
				...
				<!-- <i class="icon-user icon-xlarge"></i> -->
			...
			<ul class="dropdown-menu">
				...
				<li>
					<a href="<?php echo e(URL::route('admin.webPlan')); ?>">
						<span>Webmaster Plan</span>
					</a>
				</li>
			</ul>
		...
		<li class="dropdown-submenu <?php if($module == 'admin' || $module == 'logAdmin'): ?> active <?php endif; ?>">
			...
			<a href="<?php echo e(URL::route('admin.adminInfo')); ?>">
				<i style="font-size: 24px;" class="fas fa-users-cog" aria-hidden="true"></i>
